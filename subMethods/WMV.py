...
class WMV:
        ...
        if self.datatype == 'continuous' and self.distype == 'normalized absolute loss':
            ...
            for example, worker_label_set in list(self.e2wl.items()):
                ...
                if len(candidate)>0:
                    ...
                    self.truth[example] = random.choice(['0','1'])
    ...
    def Run(self,iterr):
        ...
        while iterr > 0:
            ...
            iterr -= 1
        e2lpd, my_e2lpd =self.get_e2lpd()
        norm_worker_weight = self.get_workerquality()
        return e2lpd, my_e2lpd, norm_worker_weight
...
if __name__ == "__main__":
    ...
    e2lpd, my_e2lpd, weight = CRH(e2wl,w2el,label_set,datatype,distancetype).Run(10)

    print(my_weight) # print worker quality
    # print('######################################')
    # print(my_e2lpd)
