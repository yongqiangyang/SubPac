...
class GLAD:
    def __init__(self,e2wl,w2el,label_set):
        ...
        self.examples = list(self.e2wl.keys())
...
#E step
    def Update_e2lpd(self):
        ...
        for example, worker_label_set in list(self.e2wl.items()):
            ...
            for tlabel, prob in list(self.prior.items()):
...
#M_step
    ...
    def gradientQ(self):
        ...
        for example, worker_label_set in list(self.e2wl.items()):
            dQb = 0
            for (worker, label) in worker_label_set:
                for tlabel in list(self.prior.keys()):
    ...
    def computeQ(self):
        ...
        for example in list(self.e2wl.keys()):
            for tlabel, prob in list(self.prior.items()):
...
#initialization
    ...
    def get_workerquality(self):
        ...
        for worker in list(self.alpha.keys()):
